...
export const AdminPrivateRequests = () => {
  ...
  const formatDate = (dateString: string) => {
    // Debug: Log the raw date string from the database
    ...
    <div className="p-6">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-2xl font-semibold text-gray-900">Private Ride Requests</h1>
          <p className="mt-2 text-sm text-gray-700">
            Manage private ride booking requests from customers
          </p>
        </div>
      </div>
