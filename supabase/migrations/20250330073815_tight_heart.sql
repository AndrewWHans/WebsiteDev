/*
  # Fix verify_ticket function to remove driver role check

  1. Changes
    - Remove driver role check completely
    - Remove all role-based verification logic
    - Keep core ticket verification functionality
*/

-- Drop existing function
DROP FUNCTION IF EXISTS verify_ticket(UUID, INTEGER, UUID);

-- Create improved verify_ticket function without any role checks
