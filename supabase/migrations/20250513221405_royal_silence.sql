...
CREATE INDEX idx_deal_bookings_user_id ON deal_bookings(user_id);
CREATE INDEX idx_deal_bookings_deal_id ON deal_bookings(deal_id);
CREATE INDEX idx_deal_bookings_status ON deal_bookings(status);

-- Update stripe-webhook function to handle deal bookings
