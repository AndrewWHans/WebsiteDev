/*
  # Add ticket verification confirmation step

  1. Changes
    - Add confirmation parameter to verify_ticket function
    - Return ticket info without verifying when confirmation is false
    - Only verify ticket when confirmation is true
*/

-- Drop existing function
DROP FUNCTION IF EXISTS verify_ticket(UUID, INTEGER, UUID);

-- Create improved verify_ticket function with confirmation step
